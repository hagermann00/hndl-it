...
class VisualBridge:
    ...
    def get_sight():
        ...
        # Moondream works best with squares/smaller images
    ...
    def execute_click(ai_x, ai_y, button="left", double=False):
        ...
        Automatically maps to Real Reality (0-1920 space).
        """
...
def test():
    ...
    print("\n2. Testing Hands (Mouse Move)...")
    # Move to center of AI View
    VisualBridge.execute_click(AI_VIEW_WIDTH/2, AI_VIEW_HEIGHT/2)
